/* Practical 4.3 :
There are n persons each have 25 paise coins, 50 paise coins and Rs1 coins in the ratio p:q:r 
but have different amounts stored in a single list. Find and print no. of 25 paise coins, 
50 paise coins and 1 Rs coins each person have.*/
