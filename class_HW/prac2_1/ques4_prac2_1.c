/*On reaching the railway station, you find that the train you wanted to catch is just 
to start and there is hardly any time for purchasing the ticket. 
The same situation faced by many people in our country. 
You have to do data analysis task for which you will record responses from N people 
and then print your report accordingly. 

User enter option a for “Rush to train to catch it and inform T.T at next stop, 
b for” Catch the train and perform journey without ticket”, 
c for “purchase the ticket first otherwise wait for next train”, 
and d for “Miss the train and take ticket for next train “.

On the basis of responses print in your report about the habit of our countrymen. 
